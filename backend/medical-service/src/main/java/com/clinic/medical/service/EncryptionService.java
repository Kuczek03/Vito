...
public class EncryptionService {
    ...
    public EncryptionService(@Value("${security.encryption-key}") String base64Key) {
        ...
        if (keyBytes.length != 32) {
            throw new IllegalArgumentException("Klucz AES musi mieć 256 bitów (32 bajty w Base64).");
        }
    ...
    public String encrypt(String plaintext) {
        ...
        try {
            ...
            throw new RuntimeException("Błąd szyfrowania.", e);
        }
    }
    ...
    public String decrypt(String base64Ciphertext) {
        ...
        try {
            ...
            throw new RuntimeException("Błąd deszyfrowania.", e);
        }
    }
